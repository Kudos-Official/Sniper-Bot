...
$let[page;$replacetext[$replacetext[$checkcondition[$userleaderboard[mtmessages;asc;\`{top}\`. **{username} - {value} messages;10;$sum[$getuservar[mt_page];1]]==];true;1];false;$sum[$getuservar[mt_page];1]]]`}]